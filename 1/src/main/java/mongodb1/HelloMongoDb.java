...
public class HelloMongoDb {
	...
	public static void main(String[] args) {
		...
		//watch out the IP, pal!mongodb+srv://mattecab:<password>@cluster0.hjvvs.mongodb.net/test
		...
		MongoDatabase databases = mongoClient.getDatabase("bird");
		//collection birds
		MongoCollection<Document> collections = databases.getCollection("birds");
		...
		Document birds = new Document ("_id",new ObjectId());
		birds.append("name", "corvo");
		collections.insertOne(birds);
